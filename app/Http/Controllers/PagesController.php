...
class PagesController extends Controller
{
    ...
    */
    public function index()
    {
        ...
        return view('front.'. $this->device .'.home', compact('seoData', 'promotions'));
    }
     ...
     */
     ...
     {
         $seoData = $this->getPageByAlias('home');
         return view('front.'. $this->device .'.general', compact('seoData'));
     }
    ...
    public function getOopsPage(Request $request)
    {
        ...
        return view('front.'. $this->device .'.dynamic.oops');
    }
