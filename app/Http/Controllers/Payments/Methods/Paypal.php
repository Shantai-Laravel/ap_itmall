...
class Paypal extends PaymentHandler
{
    ...
    {
        self::$order = CRMOrders::find($request->get('orderId'));
        self::$payment = $request->get('$payment');
    ...
    public function getPaymentCancelStatus(Request $request)
    {
        self::$order = CRMOrders::find($request->get('orderId'));
        self::$payment = $request->get('$payment');
        ...
        return redirect('/ro/order/payment/'. $request->get('orderId'));
    }
