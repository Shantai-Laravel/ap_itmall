...
<main class="contactContent wholesale cartClass">
    <!-- <h3>{{ trans('vars.Contacts.contactUs') }}</h3> -->
    <div class="contactBanner">
      <img src="/images/wholebanner.jpg" alt="">
      <div class="test">
        <div class="container">
          <div class="innerTest">
            <!-- <h3>wholesale</h3> -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-12">
                    <form action="{{ url('/'.$lang->lang.'/homewear/auth-login/static') }}" method="post">
                ...
                <div class="col-lg-6 col-md-12">
                    <form action="{{ url('/'.$lang->lang.'/homewear/registration/static') }}" method="post">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
