        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="personalData">
                    ...
                    <div class="row">
                        <div class="col-auto">
                            <p>{{ trans('vars.Shipping.shippingAdress') }}</p>
                            @if ($userdata->address) @if (!is_null($userdata->address->getCountryById))
                            <p>{{ $userdata->address->getCountryById->name }},</p>
                            @endif @if ($userdata->address->region)
                            <p>{{ $userdata->address->region }},</p>
                            @endif @if ($userdata->address->location)
                            <p>{{ $userdata->address->location }},</p>
                            @endif @if ($userdata->address->address)
                            <p>{{ $userdata->address->address }} @if ($userdata->address->homenumber) {{ $userdata->address->homenumber }} @endif</p>
                            @endif @if ($userdata->address->code)
