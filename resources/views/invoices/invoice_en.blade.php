            ...
            <div class="section table-middle">
              <table>
                <td class="furnizor">
                    ...
                    <div class="factura">Producator Homewear: AnaGeo Textil SRL</div>
                    <p>Tax-ID: <b>1017600016064</b></p>
                    <div class="factura">Producator Jewelry: Ju Bijoux SRL</div>
                    <p>Tax-ID: <b>1017600037432</b></p>
                    <p>Adresa juridică: Moldova, Chisinau, str. Puskin A., 5B</p>
                    <p>Showroom: Moldova, Chisinau, str. Puskin 8</p>
                    <p>Email: sales@annepopova.com</p>
                    <p>Telefon: (+373) 79188090, (+373) 79488188</p>
                    <p>Metoda de livrare: {{ $order->details->delivery }}</p>
                    <p>Metoda de plată: {{ $order->payment_id }}</p>
                </td>
                <td class="furnizor">
                    <div class="title">
                        Client
