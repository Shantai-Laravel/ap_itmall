        ...
        <div class="modalBody">
            <div id="registerContent" class="active" v-if="showRegisterTab">
                <div class="inputGroup">
                    ...
                    <input class="inputFocus" type="text" v-model="registerUserData.name" />
                </div>
                <div class="inputGroup">
                    <label for="name">{{ trans.vars.FormFields.fieldEmail }}</label>
                    <input class="inputFocus" type="text" v-model.trim="registerUserData.email" />
                </div>
                <div class="inputGroup">
                    ...
                    <div class="phoneContainer">
                        <div class="telefonGroup">
                            <div class="selectContainer">
                                <select class="js-example-basic-single_" name="" v-model="registerUserData.code">
                                    <option :value="country.phone_code" :data-image="'/images/flags/16x16/' + country.flag" v-for="country in countriesBeforeClick">
                        ...
                        <input class="inputFocus" type="number" v-model="registerUserData.phone" />
                    </div>
                </div>
                <div class="inputGroup">
                    <label for="name">{{ trans.vars.FormFields.pass }}</label>
                    <input class="inputFocus" type="password" v-model.trim="registerUserData.password" />
                </div>
                <div class="inputGroup">
                    <label for="name">{{ trans.vars.FormFields.passRepeat }}</label>
                    <input class="inputFocus" type="password" v-model.trim="registerUserData.passwordAgain" />
                </div>
                <div class="inputGroup">
                ...
                <div class="inputGroup" v-if="registerUserData.companyField">
                    ...
                    <input class="inputFocus" type="text" v-model="registerUserData.company" />
                </div>
            ...
            <div id="loginContent" class="active" v-if="showLoginTab">
                <div class="inputGroup">
                    <label for="name">{{ trans.vars.FormFields.fieldEmail }}</label>
                    <input class="inputFocus" type="text" v-model.trim="loginUserData.email" />
                </div>
                <div class="inputGroup">
                    <label for="name">{{ trans.vars.FormFields.pass }}</label>
                    <input class="inputFocus" type="password" v-model.trim="loginUserData.password" />
                </div>
