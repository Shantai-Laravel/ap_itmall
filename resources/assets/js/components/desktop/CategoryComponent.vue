<template>
    <div class="row">
        <div class="col-md-4" v-for="product in products" :data-productid="product.code">
...
export default {
    ...
    methods: {
        viewProductGA(product){
            // bus.$emit('ga-event-clickImpresions', {product: product, list: "One cat - " + category.translation.name});
