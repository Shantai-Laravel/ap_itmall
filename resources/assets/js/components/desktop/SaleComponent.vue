<template>
    <div class="row _wrapp" v-if="ready">
        <div class="col-lg-3 col-md-4" v-for="(product, key) in products" v-if="product" :data-productid="product.code">
            <div class="oneProduct">
                ...
                <div class="price">
                  ...
                  <span>{{ product.personal_price.old_price }} </span>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            load() {
                this.loading = true;
                axios.post('/' + this.$lang + '/'+ this.site + '/get-sale-products?page=' + this.page)
                    .then(response => {
