<template>
    <div class="row">
        <div class="col">
            <div class="row productsList">
                <div class="col-12" v-if="ready">
                    ...
                    <div class="row cartItem" v-for="(cartSubprod, key) in cartSubprods">
                            ...
                            <div class="setOpen">
                                <div class="selectContainer">
                                    <select @change="changeProductQty" :name="cartSubprod.id">
                                        <option :value="key + 1" :selected="key + 1 == cartSubprod.qty" v-for="(stoc, key) in cartSubprod.stock_qty">
                                            {{ key + 1}}
                                        </option>
                                    </select>
                                    <span>
                        ...
                        <div class="price col-auto" v-if="priceType == 'personal'">
                            <span>
                                {{ cartSubprod.subproduct.product.personal_price.price * cartSubprod.qty }} {{ $currency }}
                            </span>
                            <span></span>
                        </div>
                        <div class="price col-auto" v-if="priceType == 'main'">
                            <span>{{ cartSubprod.subproduct.product.main_price.price * cartSubprod.qty }} {{ $mainCurrency }}</span>
                            <span></span>
                            <span v-if="$mainCurrency !== $currency">({{ cartSubprod.subproduct.product.personal_price.price * cartSubprod.qty }} {{ $currency }})</span>
                        </div>
                        <div class="remove col-auto" @click="removeProduct(cartSubprod, key)"></div>
                    </div>
                    <div class="row cartItem" v-for="(cartProd, key) in cartProds">
                        ...
                        <div class="description col-md">
                            ...
                            <div class="params">
                                <span>{{ trans.vars.DetailsProductSet.qty }}: {{ cartProd.qty }}</span>
                            </div>
                            <div class="methods">
                                <div class="edit">{{ trans.vars.Cart.edit }}</div>
                            ...
                            <div class="setOpen">
                                <div class="selectContainer">
                                    <select @change="changeProductQty" :name="cartProd.id">
                        ...
                        <div class="price col-auto" v-if="priceType == 'personal'">
                            <span>
                                {{ cartProd.product.personal_price.price * cartProd.qty }} {{ $currency }}
                            </span>
                            <span></span>
                        </div>
                        <div class="price col-auto" v-if="priceType == 'main'">
                            <span>{{ cartProd.product.main_price.price * cartProd.qty }} {{ $mainCurrency }}</span>
                            <span></span>
                            <span v-if="$mainCurrency !== $currency">({{ cartProd.product.personal_price.price * cartProd.qty }} {{ $currency }})</span>
                        </div>
                        <div class="remove col-auto" @click="removeProduct(cartProd, key)"></div>
                    </div>
                </div>
                <div class="modals">
        ...
        <!-- Summary -->
        <cart-summary v-if="mode != 'order-shipping' && mode != 'order-payment'"
                    :prods="cartProds"
