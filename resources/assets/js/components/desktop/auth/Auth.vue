    ...
    <div>
        ...
        <div class="modalBody">
            <div id="registerContent">
                ...
                <p class="text-danger text-center" v-if="registerError.length > 0">
                    {{ registerError }}
                </p>
            ...
            <div id="loginContent" class="active">
                <div class="inputGroup">
                    <label for="name">{{ trans.vars.FormFields.fieldEmail }}</label>
                    <input type="text" v-model.trim="loginUserData.email" />
                </div>
                <div class="inputGroup">
                    <label for="name">{{ trans.vars.FormFields.pass }}</label>
                    <input type="password" v-model.trim="loginUserData.password" />
                </div>
