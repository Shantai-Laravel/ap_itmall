...
Route::any('/paynet-success-link/{id}/{paymentId}', 'Payments\Paynet\Paynet@successLink');
Route::any('/paynet-cancel-link/{id}/{paymentId}', 'Payments\Paynet\Paynet@cancelLink');

Route::get('/generate_pdf', 'PaymentController@generatePdf');
Route::get('/sitemap.xml', 'SitemapController@index');

Route::get('/status/{orderId}{paymnet}', 'Payments\Methods\Paypal@getPaymentStatus')->name('status');
Route::get('/cancel-status', 'Payments\Methods\Paypal@getPaymentCancelStatus')->name('cancel-status');
...
Route::group(['prefix' => $prefix], function() use ($types)  {
    ...
    foreach ($types as $key => $type) {
        ...
        {
            Route::post('/registration/static', 'AuthController@registrationStatic');
            Route::post('/auth-login/static/auth', 'AuthController@loginStatic');
