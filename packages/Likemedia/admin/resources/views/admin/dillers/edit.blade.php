        ...
        <div class="part left-part">
            ...
            <ul>
                ...
                <li>
                    ...
                    <input type="text" name="name" class="name" id="name" value="{{$user->contact_person}}">
                </li>
                <li>
                    <label for="name">Password</label>
                    <input type="text" disabled value="{{$user->pass_str}}">
                </li>
                <li>
                ...
                <li>
                    ...
                    <input type="text" name="country" class="name" disabled value="{{$user->country}}">
                </li>

                <li>
                    <label for="phone">City</label>
                    <input type="text" name="city" class="name" disabled value="{{$user->city}}">
                </li>

                <li>
                    <label for="phone">Street</label>
                    <input type="text" name="street" class="name" disabled value="{{$user->street}}">
                </li>

                <li>
                    <label for="phone">Apartment</label>
                    <input type="text" name="apartment" class="name" disabled value="{{$user->apartment}}">
                </li>
