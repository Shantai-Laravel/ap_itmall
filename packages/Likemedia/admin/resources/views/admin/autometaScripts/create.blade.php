...
<div class="title-block">
    <h3 class="title"> Create Script </h3>
</div>
@include('admin::admin.alerts')
<div class="list-content">
    <div class="card">
        <div class="card-block">
            <form class="form-reg" role="form" method="POST" action="{{ route('autometa-scripts.store') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-12 alert-warning"> <br>
                        @if (Request::get('type') == 'product')
                            <input type="hidden" name="type" value="product">
                            <h6>Creating script for <b>Products</b>. </h6> <hr>
                        ...
                        @elseif (Request::get('type') == 'collection')
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                @foreach ($langs as $key => $lang)
                                    <td class="input-block"> <input type="text" name="var1[{{$lang->id}}]" value=""/> </td>
                                @endforeach
                            </tr>
                            <tr>
                                <td><span class="label label-success">{var2}</span></td>
                                @foreach ($langs as $key => $lang)
                                    <td class="input-block"> <input type="text" name="var2[{{$lang->id}}]" value=""/> </td>
                                @endforeach
                            </tr>
                            <tr>
                                <td><span class="label label-success">{var3}</span></td>
                                @foreach ($langs as $key => $lang)
                                    <td class="input-block"> <input type="text" name="var3[{{$lang->id}}]" value=""/> </td>
                                @endforeach
                            </tr>
                            <tr>
                                <td><span class="label label-success">{var4}</span></td>
                                @foreach ($langs as $key => $lang)
                                    <td class="input-block"> <input type="text" name="var4[{{$lang->id}}]" value=""/> </td>
                                @endforeach
                            </tr>
                            <tr>
                                <td><span class="label label-success">{var5}</span></td>
                                @foreach ($langs as $key => $lang)
                                    <td class="input-block"> <input type="text" name="var5[{{$lang->id}}]" value=""/> </td>
                                @endforeach
                            </tr>
                            <tr>
                                <td><span class="label label-success">{var6}</span></td>
                                @foreach ($langs as $key => $lang)
                                    <td class="input-block"> <input type="text" name="var6[{{$lang->id}}]" value=""/> </td>
                                @endforeach
                            </tr>
                            <tr>
                                <td><span class="label label-success">{var7}</span></td>
                                @foreach ($langs as $key => $lang)
                                    <td class="input-block"> <input type="text" name="var7[{{$lang->id}}]" value=""/> </td>
                                @endforeach
                            </tr>
                            <tr>
                                <td><span class="label label-success">{var8}</span></td>
                                @foreach ($langs as $key => $lang)
                                    <td class="input-block"> <input type="text" name="var8[{{$lang->id}}]" value=""/> </td>
                                @endforeach
                            </tr>
                            <tr>
                                <td><span class="label label-success">{var9}</span></td>
                                @foreach ($langs as $key => $lang)
                                    <td class="input-block"> <input type="text" name="var9[{{$lang->id}}]" value=""/> </td>
                                @endforeach
                            </tr>
                            <tr>
                                <td><span class="label label-success">{var10}</span></td>
                                @foreach ($langs as $key => $lang)
                                    <td class="input-block"> <input type="text" name="var10[{{$lang->id}}]" value=""> </td>
                                @endforeach
                            </tr>
                            <tr>
                                <td><span class="label label-success">{var11}</span></td>
                                @foreach ($langs as $key => $lang)
                                    <td class="input-block"> <input type="text" name="var11[{{$lang->id}}]" value=""> </td>
                                @endforeach
                            </tr>
                            <tr>
                                <td><span class="label label-success">{var12}</span></td>
                                @foreach ($langs as $key => $lang)
                                    <td class="input-block"> <input type="text" name="var12[{{$lang->id}}]" value=""> </td>
                                @endforeach
                            </tr>
                            <tr>
                                <td><span class="label label-success">{var13}</span></td>
                                @foreach ($langs as $key => $lang)
                                    <td class="input-block"> <input type="text" name="var13[{{$lang->id}}]" value=""> </td>
                                @endforeach
                            </tr>
                            <tr>
                                <td><span class="label label-success">{var14}</span></td>
                                @foreach ($langs as $key => $lang)
                                    <td class="input-block"> <input type="text" name="var14[{{$lang->id}}]" value=""> </td>
                                @endforeach
                            </tr>
                            <tr>
                                <td><span class="label label-success">{var15}</span></td>
                                @foreach ($langs as $key => $lang)
                                    <td class="input-block"> <input type="text" name="var15[{{$lang->id}}]" value=""> </td>
                                @endforeach
                            </tr>
                        </tbody>
                    </table>
                                    ...
                                    <div id="collapseTwo{{ $lang->id }}" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                      <div class="panel-body">
                                          <div class="form-group">
                                              ...
                                              <textarea name="description[{{$lang->id}}]" rows="2" cols="80" class="form-control"></textarea>
                                              <label for="">Meta Title</label>
                                              <textarea name="meta_title[{{$lang->id}}]" rows="2" cols="80" class="form-control"></textarea>
                                              <label for="">Meta Description</label>
                                              <textarea name="meta_description[{{$lang->id}}]" rows="2" cols="80" class="form-control"></textarea>
                                              <label for="">Meta Keywords</label>
                                              <textarea name="meta_keywords[{{$lang->id}}]" rows="2" cols="80" class="form-control"></textarea>
                                          </div>
                                      </div>
                                    </div>
                                  </div>
