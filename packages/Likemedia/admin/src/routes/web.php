...
Route::group(['middleware' => ['web']], function ()
{
    ...
    Route::group(['namespace' => $namespace, 'prefix' => 'back', 'middleware' => 'auth'], function ()
    {
        ...
        Route::post('auto-upload-set-image', 'AutoUploadController@setImage');
        ...
        Route::post('auto-upload-get-adjacent-productList', 'AutoUploadController@getAdjacentProductList');
        Route::post('auto-upload-select-adjacent-productList', 'AutoUploadController@selectAdjacentProductList');
        Route::post('auto-upload-select-similar-productList', 'AutoUploadController@selectSimilarProductList');
        ...
        // Route::get('/product-collections/delete-banner/icon/{id}', 'CollectionsController@deleteBannerIcon');
        ...
        Route::get('/product-categories/delete-banner/icon/{id}', 'ProductCategoryController@deleteBannerIcon');
